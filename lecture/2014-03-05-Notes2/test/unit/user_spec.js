...
describe('User', function(){
  ...
  beforeEach(function(done){
    global.nss.db.dropDatabase(function(err, result){
      ...
      sue.hashPassword(function(){
        sue.insert(function(records){
          console.log('BEFORE EACH :', err, records)
          done();
        });
      });
    });
  ...
  describe('#hashPassword', function(){
    it('should have password with salt', function(done){
      var u1 = new User({email:'bob@aol.com', password: '1234'});
  ...
  describe('#insert', function(){
    it('should enter user into Mongo', function(done){
      var u1 = new User({email:'bob@aol.com', password:'1234'});
      u1.hashPassword(function(){
    ...
    it('should not insert duplicate user into mongo', function(done){
      ...
      u1.hashPassword(function(){
        u1.insert(function(records){
          console.log('DUPLICATE TEST: ', records);
    ...
    describe('findByEmailAndPassword', function(){
      it('should find user by email and password', function(done){
        User.findByEmailAndPassword('bob@aol.com', 'abcd', function(user){
