(function(){
  ...
  var images = ['farley.png', 'billie.png', 'bonham.png', 'cash.png', 'duke.png', 'elvis.png', 'hendrix.png',
    'kurt.png', 'miles.png', 'tupac.png'];
  ...
  function clickSquare(){
    ...
    if(clickCount % 2 !== 0 && clickCount > 1){
      if(lastClick.assigned !== -1){
        $(lastClick).css('background-image', 'url(/media/question.jpg');
      }
